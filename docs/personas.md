...
> Derived from the product brief. Primary segment: cutting & bulking.
...
### Pain Points
- No app plans the full week AND generates the shopping list in one place
...
### What She'd Pay For
A frictionless Sunday routine: input her goal, get a plan, get a list, shop, done.
...
| | Marcus | Priya |
|---|---|---|
| **Primary driver** | Macro precision | Time savings |
| **Goal** | Bulk | Cut |
| **Tech savviness** | High | Medium |
| **Willingness to pay** | Immediate Pro | Pro if value proven |
| **Retention risk** | Low (habitual tracker) | Medium (busy, drops off) |
| **Word-of-mouth potential** | High (gym community) | Medium |
